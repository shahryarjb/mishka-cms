defmodule MishkaDatabase.Schema.MishkaContent.Blogs do
  use Ecto.Schema
  ...
  @all_fields ~w(title short_description images description status priority alias_link meta_keywords meta_description)a
